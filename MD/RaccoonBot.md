...
## Play a Note
The RaccoonBot plays the specified musical note.
...
## Battery Voltage
Returns the RaccoonBot's battery voltage value.  
The volage is approximatedly `4.0V` when the battery is fully charged.  
It typically operates stably at `3.7V` or higher.  
Since operating errors may occur if the voltage drops below `3.45V`,  
charing is strongly recommended.  


<img src="https://github.com/user-attachments/assets/1784e47c-6f45-4c61-a9f4-92fe10e252e4" width="50%" height="50%" >
