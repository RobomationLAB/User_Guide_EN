...
| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| color | Input Value | Delta R, G, B values | Integers for each of R, G, B: Integer -255 ~ 255 | 
...
The range of achievable frequencies is from 1.0hz to 6553.5hz.  
If a value outside the range is entered, the buzzer sound will not be produced. 

<img src="https://github.com/user-attachments/assets/c5abb922-f772-464e-a04e-974697709552" width="60%" height="60%" >


### Dropdown Options and Input Values
| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| sound | Input Value | Buzzer frequency | 1.0 ~ 6553.5 (hz) |

### JavaScript Code
```javascript
// Set buzzer frequency to 1000hz
...
<img src="https://github.com/user-attachments/assets/6abaaba5-9761-46f2-b574-765efc2f4048" width="70%" height="70%" >
...
## Wheel Speed Value
Returns the specified wheel speed value.
...
## Floor Color Sensor Value
Returns the Turtle’s floor color sensor value.  
It recognizes black or colored lines drawn on the floor.  
It is automatically adjusted based on A4 paper, 0 is black and 100 is white.  
When a color is recognized, it approaches the black value.

<img src="https://github.com/user-attachments/assets/d2b02b2e-9e3a-4818-811d-4761abe14047" width="40%" height="40%" >
...
Returns the 'color pattern' of the card read by the color sensor under the Turtle's head.  
* How to recognize: Pass the card through the sensor in the order of white strip -> color strip -> background.  
* Reading Result: The result appears as a two-digit number, representing the [tens digit = color strip] and [units digit = background color].  
* Example: When a card with 'purple(7) strip' and 'red(1) background' is read, the result is 71.  
...
## Acceleration Value
Returns the acceleration value for a specific axis.  
The accelerometer is a sensor that measures how quickly the Turtle moves or tilts.  
The range is -128 to +127.  
* X-axis: Changes when tilting the robot forward or backward.  
* Y-axis: Changes when tilting the robot left or right.  
* Z-axis: Changes when flipping the robot up or down.  
...
Returns the Turtle’s temperature sensor value.  
It represents the internal temperature of the robot, not the room temperature.  
The range is -40.0 to +87.5 degrees(°C).  
...
Returns the Turtle’s signal strength value.  
It indicates the signal strength between the robot and the dongle.  
The value increases as the distance decreases.  
For the stable operation, it is recommended to use within the range of -50dBm ~ -80dBm.  
If the signal strength value is closer to 0, the signal is stronger. (e.g. -40 > -90)  
...
## Battery Voltage
Returns the Turtle’s battery voltage value.  
The volage is approximatedly `4.0V` when the battery is fully charged.  
It typically operates stably at `3.7V` or higher.  
Since operating errors may occur if the voltage drops below `3.6V`,  
charing is strongly recommended.  

<img src="https://github.com/user-attachments/assets/70138b17-08f4-4caf-9125-32f66a0280c9" width="50%" height="50%" >
...
<img src="https://github.com/user-attachments/assets/cdbb7d6c-f2bb-4a9d-b9c6-a90c0594b395" width="70%" height="70%" >

### Dropdown Options and Input Values

| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| color | Dropdown Option | Detected color | red(1), orange(2), yellow(3), green(4), cyan(5), blue(6), magenta(7), white(8) |
...
<img src="https://github.com/user-attachments/assets/69723fc6-b7aa-4240-bbbb-6361e41759d6" width="70%" height="70%" >
