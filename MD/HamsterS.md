...
The range of achievable frequencies is from 122.1hz to 4186.0hz.  
If a value outside the range is entered, the buzzer sound will not be produced.  

<img src="https://github.com/user-attachments/assets/ca3377e5-c4fe-4fa3-969b-a15d4e8d33ca" width="60%" height="60%" >


### Dropdown Options and Input Values
| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| sound | Input Value | Buzzer frequency | 122.1 ~ 4186.0 (hz) |
...
<img src="https://github.com/user-attachments/assets/ac26f261-c76d-41e0-a279-ae7a8b853802" width="60%" height="60%" >
...
| octave | Dropdown Option | Octave | 3 ~ 7 |
...
## Wheel Speed Value
Returns the specified Hamster S wheel speed value.
...
Returns the specified Hamster S proximity sensor value.  
The closer the object is, the larger the value becomes.  
...
## Floor Sensor Value
Returns the specified Hamster S floor sensor value.  
Black represents the minumum value, and white represents the maximum value.  
The range is 0 to 100.  

<img src="https://github.com/user-attachments/assets/5d3a0bb7-8e74-4c69-9846-c370418d06db" width="40%" >

* White is set to 100 based on A4 paper for printers.  
...
## Acceleration Value
Returns the Hamster S acceleration value for a specific axis.  
The accelerometer is a sensor that measures how quickly Hamster S moves or tilts.  
The range is -32768 to +32767.  
Since Earth's gravity (1g) acts downwards, the Earth's gravity value is Z = -16384.  
...
## Light Sensor Value
Returns Hamster S light sensor value.  
The value increases when the surroundings are bright, and decreases when it is dark.  
...
Returns Hamster S temperature sensor value.  
...
Returns Hamster S signal strength value.
...
## Battery Voltage
Returns Hamster S battery voltage value.  
The volage is approximatedly `4.0V` when the battery is fully charged.  
It typically operates stably at `3.7V` or higher.  
Since operating errors may occur if the voltage drops below `3.25V`,  
charing is strongly recommended.  

<img src="https://github.com/user-attachments/assets/c58098ef-8e76-4749-b1b6-f65f5182f28e" width="50%" height="50%" >
...
<img src="https://github.com/user-attachments/assets/6717948a-9c37-404c-9b94-f96549a281f3" width="80%" height="80%" >


### Dropdown Options and Input Values
| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| angle | Input Value | Shooter angle | Integer 0 ~ 180 |

### JavaScript Code
```javascript
// Set Hamster S shooter angle to 180
...
## IO Port Input Value
Returns Hamster S I/O port input value.
