...
<img src="https://github.com/user-attachments/assets/7fa7f3b8-aea9-44f9-9662-023b7d17e826" width="70%" height="70%" >
...
## Wheel Speed Value
Returns the specified Hamster wheel speed value.
...
Returns the specified Hamster proximity sensor value.  
...
## Floor Sensor Value
Returns the specified Hamster floor sensor value.  
...
## Acceleration Value
Returns the Hamster acceleration value for a specific axis.  
The accelerometer is a sensor that measures how quickly Hamster moves or tilts.  
...
## Light Sensor Value
Returns the Hamster’s light sensor value.  
...
Returns the Hamster’s temperature sensor value.  
...
Returns the Hamster’s signal strength value.  
...
## Battery Voltage
Returns the Hamster’s battery voltage value.  
The volage is approximatedly `4.0V` when the battery is fully charged.  
It typically operates stably at `3.7V` or higher.  
Since operating errors may occur if the voltage drops below `3.5V`,  
charing is strongly recommended.  

<img src="https://github.com/user-attachments/assets/e1809ccb-4974-4a06-a8a3-6cb683e6f7ee" width="60%" height="60%" >
...
<img src="https://github.com/user-attachments/assets/aa5c3a0d-82a1-4fd8-b616-32fdc6dab905" width="70%" height="70%" >
...
### JavaScript Code
```javascript
// Set Hamster shooter angle to 180
...
## IO Port Input Value
Returns the Hamster I/O port input value.
