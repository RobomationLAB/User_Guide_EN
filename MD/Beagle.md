...
The range of achievable frequencies is from 27.5hz to 6553.5hz.  
If a value outside the range is entered, the buzzer sound will not be produced. 

<img src="https://github.com/user-attachments/assets/8f32e642-761b-47cf-8028-becece58a21c" width="90%" height="90%" >

### Dropdown Options and Input Values
| Name | Type | Description | Range / Type |  
| ------ | ------ | ------ | ------ |
| sound | Input | Buzzer frequency | 27.5 ~ 6553.5 (hz) |
...
## Wheel Speed Value
Returns the set wheel speed value of the Beagle.
...
## Encoder Value
Returns the encoder value of the specified Beagle wheel.  
The value increases by the number of steps the Beagle moves.  
The value increases when moving in the forward direction and decreases when moving in the reverse direction.  
...
## Gyroscope Value
Returns the gyroscope sensor value on a specific axis of the Beagle.  
A gyroscope sensor is a sensor that measures the angular velocity of each axis to determine the rotational speed and direction per second as a value.  
The range of the gyroscope sensor is ±250º/s.  

* X-axis: Changes when tilting the Beagle to the left or right.  
* Y-axis: Changes when tilting the Beagle forward or backward.  
* Z-axis: Changes when placing the Beagle horizontally and rotating it left or right.  
...
## Accelerometer Value
Returns the accelerometer sensor value on a specific axis of the Beagle.  
The accelerometer is a sensor that measures how quickly the Beagle moves or tilts.  
The range of the accelerometer is ±2g.  

* X-axis: Changes when tilting the Beagle forward or backward.  
* Y-axis: Changes when tilting the Beagle left or right.  
* Z-axis: Changes when flipping the Beagle up or down.  
...
## Magnetometer Value
Returns the magnetometer sensor value on a specific axis of the Beagle.  
The magnetometer is a sensor capable of determining direction by measuring the surrounding magnetic field (magnetic force).  
The magnetic field strength of each axis (X, Y, Z) can be checked as a value, allowing the robot's orientation to be determined.  

* X-axis: Measures changes in the magnetic field in the left-right direction.  
* Y-axis: Measures changes in the magnetic field in the front-back direction.  
* Z-axis: Measures changes in the magnetic field in the up-down direction.  
...
Returns the Beagle’s temperature sensor value.  
...
Returns the Beagle’s signal strength value.  
...
## Battery Voltage
Returns the Beagle’s battery voltage value.  
...
<img src="https://github.com/user-attachments/assets/b56384b2-3e2c-48c3-adf8-a310e102cb0d" width="40%" height="40%" >
